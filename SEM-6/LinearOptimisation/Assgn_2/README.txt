...
Instructions to run:
    ...
    2) By default our code runs all the test cases present in "test_Q2/" directory.

    3) Sample testcases given in Google Classroom are provided 
       in test_Q2 directory. To add new test files add them in the 
       test_Q2 directory as a txt file with the following format :
       ...
       1 line of X with values in array as space separated
    ...
    5) To run - $ python3 assignment2.py