...
Original file is located at
    https://colab.research.google.com/drive/1s8tycqRk3gXKwy9Xgbjl6OiGWIjwxADv

### Note: 
This Notebook is for quick evaluation of the stacked ensembling model for the Assignment. 
Click Run all and download the Submission.csv in Output for evaluation

In kaggle notebook Click **Add data** --> **Search By URL** -->type ***www.kaggle.com/akashtadwai45/weights***  
...
Gboost= "./weights/Gboost.pkl"  # Loading weights from weights file
...
lgb= "./weights/lgb.pkl"       # Loading weights from weights file
...
rf="./weights/rf.pkl"          # Loading weights from weights file
...
stacked="./weights/stacked.pkl"  # Loading weights from weights file
...
xgb="./weights/xgb.pkl"          # Loading weights from weights file
